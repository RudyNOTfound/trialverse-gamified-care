...
const RegisterDoctor = () => {
  ...
  const formFields = [
    ...
    { label: "Medical License Number", type: "text", placeholder: "Enter your medical license number" },
    { label: "Specialization", type: "text", placeholder: "Enter your specialization" },
    { label: "Centre ID", type: "text", placeholder: "Enter centre ID (if applicable)" },
      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          <h1 className="text-4xl font-bold mb-4 bg-gradient-primary bg-clip-text text-transparent">
            Join TrialVerse as Doctor
          </h1>
          <p className="text-muted-foreground text-lg">
            Connect your wallet and register to start managing clinical trials
          </p>
        </motion.div>
        ...
        {!walletConnected ? (
          ...
          >
            ...
            <p className="text-muted-foreground mb-6">
              Secure your medical credentials and identity with blockchain technology
            </p>
            <button
          ...
          >
            <h2 className="text-2xl font-semibold mb-6">Doctor Details</h2>
            <div className="space-y-6">
              ...
              >
                Complete Doctor Registration 👨‍⚕️
              </motion.button>
            </div>
          </motion.div>
        )}
